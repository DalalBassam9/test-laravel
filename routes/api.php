...
Route::get('/products/boxes', [APIProductController::class, 'getProductBoxs']);
Route::get('products/regulars', [APIProductController::class, 'getProductRegulars']);
...
Route::prefix('admin')->group(function () {
    ...
    Route::post('/products/{id}', [ProductController::class, 'update']); // تغيير POST إلى PUT
    ...
    Route::post('/categories/{id}', [AdminCategoryController::class, 'update']); // تغيير POST إلى PUT
    ...
    Route::post('/feedback', [AdminFeedbackController::class, 'index']);
    Route::post('/feedback', [AdminFeedbackController::class, 'store']);
